...
RL = dict(
    ...
    phi_L  = np.array([ 1.081e+03,  3.427e+02,  3.470e+01,  5.903e+00,  1.274e+00, 2.323e-01,  7.175e-02,  9.722e-02, -4.936e-02]) * 1e-6,
    phi_R  = np.array([-168.869, -157.443,  -90.362,  -44.067,  -23.429, -9.843,   -4.865,   -2.374,   -1.729]) * 1e-6,
...
RC = dict(
    ...
    V_C = np.array([9.961, 9.951, 9.858, 9.267, 7.275, 6.058, 4.731, 2.494, 1.704, 1.304, 1.145, 0.803]),
    V_R = np.array([0.45 , 0.955, 1.814, 3.561, 6.916, 7.927, 8.815, 9.575, 9.759, 9.991, 9.95 , 9.921]),

    sigma_V_in = np.array([0.065, 0.017, 0.052, 0.042, 0.031, 0.037, 0.034, 0.087, 0.008, 0.045, 0.032, 0.043]),
    sigma_V_C = np.array([0.021, 0.046, 0.044, 0.026, 0.039, 0.008, 0.045, 0.103, 0.098, 0.028, 0.027, 0.06 ]),
    sigma_V_R = np.array([0.056, 0.109, 0.042, 0.009, 0.089, 0.055, 0.07 , 0.064, 0.044, 0.07, 0.023, 0.072]),

    phi_in = np.array([ 0.101,  0.012,  0.001, -0.214, -0.173,  0.084,  0.067,  0.036, -0.14 , -0.059, -0.146,  0.005]) * 1e-6,
    phi_C = np.array([-29.863, -29.701, -29.524, -28.481, -23.942, -21.029, -17.299, -10.535, -7.375,  -5.688,  -4.687,  -3.959]) * 1e-6,
    phi_R = np.array([1.220e+03, 4.699e+02, 2.205e+02, 9.644e+01, 2.606e+01, 1.486e+01, 7.933e+00, 2.004e+00, 9.913e-01, 6.863e-01, 3.970e-01, 3.277e-01]) * 1e-6,
