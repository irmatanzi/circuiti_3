...
phi_A = np.array([np.mean ([920, 1080]), np.mean ([320, 360]), np.mean ([532, 548]), np.mean ([195, 204]), np.mean ([98, 102]), 
                  np.mean ([39.8, 41.1]), np.mean ([19.6, 20.2]), np.mean ([9.60, 10.0]), np.mean ([7.20, 7.32])]) # micro secondi
sigma_phi_A = np.array([0.01, 0.01, 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01]) # DA FARE micro secondi
phi_B = np.array([np.mean ([920, 1200]), np.mean ([390, 470]), np.mean ([588, 620]), np.mean ([230, 246]), np.mean ([121, 123]),
                  np.mean ([48.4, 51]), np.mean ([24.2, 24.8]), np.mean ([12.8, 13.3]), np.mean ([8.68, 9.12])]) # micro secondi (circa -0.25)
sigma_phi_B = np.array([0.01, 0.01, 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 ]) # DA FARE micro secondi
phi_AB = np.array([np.mean ([420, 500]), np.mean ([0, 190]), np.mean ([472, 500]), np.mean ([192, 200]), np.mean ([97, 99]),
                   39.6, 19.6, np.mean ([10.4, 10.5]), np.mean ([7.16, 7.20])]) # micro secondi (circa -0.25)
sigma_phi_AB = np.array([0.01, 0.01, 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 , 0.01 ]) # DA FARE micro secondi
